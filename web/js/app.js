...
(function () {
  ...
  if (typeof window.getCountryFlag !== 'function') {
    window.getCountryFlag = function () { return ''; };
  }
  ...
  if (typeof window.isDarkTheme !== 'function') {
  ...
  if (typeof window.showErrorBanner !== 'function') {
    window.showErrorBanner = function (message) {
      ...
      banner.textContent = message || 'Data unavailable';
      banner.classList.remove('hidden');
    };
  }
  if (typeof window.hideErrorBanner !== 'function') {
    window.hideErrorBanner = function () {
      var banner = document.getElementById('error-banner');
      if (banner) banner.classList.add('hidden');
    };
  }
  if (typeof window.isValidDashboardData !== 'function') {
    window.isValidDashboardData = function (data) {
